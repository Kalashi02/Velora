    ...
    <div className="checkout-container fade-in">
      ...
      <div className="checkout-left">
        ...
        <form onSubmit={handlePlaceOrder}>
          ...
          <div style={{ display: "flex", justifyContent: "center", gap: "25px", marginTop: "30px", paddingBottom: "20px" }}>
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "8px" }}>
              ...
              <span style={{ fontSize: "0.75rem", color: "#555", textAlign: "center", textTransform: "uppercase", letterSpacing: "1px" }}>Secure<br/>Checkout</span>
            </div>
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "8px" }}>
               <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#555" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
               ...
               <span style={{ fontSize: "0.75rem", color: "#555", textAlign: "center", textTransform: "uppercase", letterSpacing: "1px" }}>Free<br/>Shipping</span>
            </div>
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "8px" }}>
               <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#555" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
               ...
               <span style={{ fontSize: "0.75rem", color: "#555", textAlign: "center", textTransform: "uppercase", letterSpacing: "1px" }}>30-Day<br/>Returns</span>
            </div>
          </div>
        </form>
      </div>
